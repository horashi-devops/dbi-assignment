-- ==============================================================================
-- FILE: query.sql
-- MỤC ĐÍCH: Chứa các câu lệnh truy vấn dữ liệu từ AttendanceDB
-- ==============================================================================
...
WHERE c.ClassCode = 'SE1801_INT3111';
...
JOIN Class c ON cs.ClassId = c.Id
WHERE s.StudentCode = 'HE180001' 
  AND c.ClassCode = 'SE1801_INT3111'
